...
add_action('wp_enqueue_scripts', function () {
  ...
  if(is_page('bizcopilot_services')) {
    wp_enqueue_style( 'layout-recruit', get_theme_file_uri( '/assets/css/layout-recruit.css' ), '', filemtime( get_theme_file_path( '/assets/css/layout-recruit.css' ) ) );
    wp_enqueue_style( 'style-recruit', get_theme_file_uri( '/css/style-recruit.css' ), '', filemtime( get_theme_file_path( '/css/style-recruit.css' ) ) );
  }
});
...
<ul>
        ...
        <li><a href="#BizCopilotServices">BizCopilot</br>サービス</a></li>
        <li><a href="#BizLog">BizLog</a></li>
</ul>
</div>
...
<!-- 左から -->
<section id="BizCopilotServices" class="l-section-container -page-section-left section-about">
    <div class="adjust-width">
        <div class="myContainer">
            <div class="myBox order2">
            <h2 class="page-section-title">
                    ...
                    <span>BizCopilotの拡張機能</span>
                </h2>
                <br>
                <p class="page-section-paragraph">
                弊社製品である、Azure OpenAI Serviceを利用したセキュアな環境でお使いいただける社内利用向けChatGPT「BizCopilot」の拡張機能導入サービスです。生成AIの機能をより充実させることでより業務の効率化を目指すことができます。
                </p>
                <br>
                <br>
                <a class="myButton" href="https://deepcom.co.jp/bizcopilot_services/" target="_blank" rel="noopener" style="text-decoration:none;">より詳しくみる</a>
            </div>
            <div class="myBox order1">
                <picture>
                    <source media="(max-width: 767px)"
...
<!-- 右から -->
<section id="BizLog" class="l-section-container -page-section-right section-about">
    <div class="adjust-width">
        <div class="myContainer">
            <div class="myBox">
                <picture>
            ...
            <div class="myBox">
                <h2 class="page-section-title">
                    ...
                    <!-- <span class="ja-38"></span> -->
                    <span class="txt">Microsoft Cloudログ分析ソリューション</span>
                </h2>
                <p class="page-section-paragraph">
                Microsoft 365のアクセスログ、監査ログを収集＆分析するSaaSです。<br>組織のエンゲージメント状況や、会社の方針に対する情報の閲覧状況や活用状況を把握し、最適な情報発信・共有の仕組みを作ることが可能になります。
                </p>
                <a class="myButton" href="/bizlog/" target="_blank" rel="noopener" style="text-decoration:none;">より詳しくみる</a>
            </div>
        </div>
    </div>
</section>
