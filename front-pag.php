...
<main class="g-main">
  <div class="top-container">
    ...
    <section class="l-section-container -decoration-square-right -decoration-square-right-olive section-feature">
      <div class="adjust-width">
        <h2 class="l-section-title l-section-title-olive"><span class="en">ADVANTAGEああ</span><span class="ja">DeepComの３つの強み</span></h2>
