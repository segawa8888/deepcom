...
<main class="g-main">
  <div class="page-header">
    <div class="page-title adjust-width">
      <h1>
      <?php if( is_page('company') ): ?>About US<?php endif; ?>
        <?php if( is_page('imdivision') ): ?>About US<?php endif; ?>
        <?php if( is_page('msdivision') ): ?>About US<?php endif; ?>
      ...
      <?php if( is_page('enterprise_chatgpt') ): ?>PRODUCT<?php endif; ?>
      <?php if( is_page('news') ): ?>NEWS<?php endif; ?>
      <?php if( is_page('bizcopilot_services') ): ?>BizCopilot SERVICE<?php endif; ?>
      <?php if( is_page('product_bizprom') ): ?>BizProm PRODUCT<?php endif; ?>
      <?php if( is_page('product_teams') ): ?>Teams PRODUCT<?php endif; ?>
      <?php if( is_page('product_powerplatform') ): ?>Power Platform PRODUCT<?php endif; ?>
