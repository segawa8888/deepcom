    ...
    <div class="main-image">
      <div class="adjust-width">
        ...
        <div class="contents" style="width:100%;">
          <p class="main-copy2"style="color: black;line-height: 1;font-family: a-otf-gothic-mb101-pr6n, sans-serif;font-style: normal;font-weight: bold;">社内の</br>Microsofクラウドを</br>より利用促進したい</p>
          <!--<div class="site-copy">
            <p class="text">Microsoft製品に関する各種導入支援サービスと運用支援サービスを中心に、サービスを展開しています。</p>
            <div class="icon">
              <picture>
