						...
						<section class="navi-pc-inner">
							...
							<div class="navi-pc-inner-column">
								...
								<a class="navi-pc-inner-column-item" href="<?php echo esc_url( home_url( '/powerplatform_governance/' ) ); ?>">
									...
									<span class="navi-pc-inner-column-item-sub">導入前のガバナンス・セキュリティ定義</span><span class="navi-pc-inner-column-item-ttl">Power Platform<br>導入支援サービス</span>
								</a><!-- /.navi-pc-inner-column-item -->
								...
								<a class="navi-pc-inner-column-item" href="<?php echo esc_url( home_url( '/sharepointonline_migrationservice/' ) ); ?>">
									...
									<span class="navi-pc-inner-column-item-sub">オンプレミスからクラウド化</span><span class="navi-pc-inner-column-item-ttl">SharePoint Online<br>移行支援サービス</span>
								</a><!-- /.navi-pc-inner-column-item -->
								...
								<a class="navi-pc-inner-column-item" href="<?php echo esc_url( home_url( '/bizcopilot_services/' ) ); ?>">
									<span class="navi-pc-inner-column-item-thumb"><img src="<?php echo get_theme_file_uri('/assets/images/services/07_dynamics365_sales_kv.png'); ?>" alt=""></span>
									<span class="navi-pc-inner-column-item-sub">BizCopilotの拡張機能</span><span class="navi-pc-inner-column-item-ttl">BizCopilot サービス</span>
								</a> <!-- /.navi-pc-inner-column-item --> 
								<a class="navi-pc-inner-column-item" href="<?php echo esc_url( home_url( '/bizlog/' ) ); ?>">
									<span class="navi-pc-inner-column-item-thumb"><img src="<?php echo get_theme_file_uri('/assets/images/services/05_SharePoint_kv.png'); ?>" alt=""></span>
									<span class="navi-pc-inner-column-item-sub">Microsoft Cloud<br>ログ分析ソリューション</span><span class="navi-pc-inner-column-item-ttl">BizLog</span>
								</a> 
								<!-- /.navi-pc-inner-column-item --> 
					...
					<li class="navi-pc-parent-list-second-inner">
						<section class="navi-pc-inner">
							<div class="navi-pc-inner-ttl">
								...
								<!-- <a class="navi-pc-inner-ttl-btn" href="<?php echo esc_url( home_url( '/product_bizprom/' ) ); ?>">BizProm</a>
								<br>
								<a class="navi-pc-inner-ttl-btn" href="<?php echo esc_url( home_url( '/enterprise_chatgpt/' ) ); ?>">BizCopilot</a>
								<br>
								<a class="navi-pc-inner-ttl-btn" href="<?php echo esc_url( home_url( '/product_teams/' ) ); ?>">Teams</a>
								<br>
								<a class="navi-pc-inner-ttl-btn" href="<?php echo esc_url( home_url( '/product_powerplatform/' ) ); ?>">Power Platform</a> -->
							</div><!-- /.navi-pc-inner-ttl -->
							<div class="navi-pc-inner-column">
								...
								<a class="navi-pc-inner-column-item" href="<?php echo esc_url( home_url( '/enterprise_chatgpt/' ) ); ?>">
									<span class="navi-pc-inner-column-item-thumb"><img src="<?php echo get_theme_file_uri('/assets/images/navi-pc/products-img12.png'); ?>" alt=""></span>
									<span class="navi-pc-inner-column-item-sub">Azure</span><span class="navi-pc-inner-column-item-ttl">BizCopilot Powered By ChatGPT</span>
								</a><!-- /.navi-pc-inner-column-item -->
							</div><!-- /.navi-pc-inner-column -->
				...
				<div class="navi-sp-option">
					...
					<div class="navi-sp-content">
						<ul>
							...
							<li><a href="<?php echo esc_url( home_url( '/bizcopilot_services/' ) ); ?>"><span class="navi-sp-content-sub">BizCopilotの拡張機能</span><span class="navi-sp-content-main">BizCopilot サービス</span></a></li>
							<li><a href="<?php echo esc_url( home_url( '/bizlog/' ) ); ?>"><span class="navi-sp-content-sub">Microsoft Cloudログ分析ソリューション</span><span class="navi-sp-content-main">BizLog</a></li>
						</ul>
					</div>
				</div>
				...
				<div class="navi-sp-option">
					...
					<div class="navi-sp-content">
						<ul>
							...
							<li><a href="<?php echo esc_url( home_url( '/enterprise_chatgpt/' ) ); ?>"><span class="navi-sp-content-sub navi-sp-content-sub-b">Azure</span><span class="navi-sp-content-main">BizCopilot Powered By ChatGPT</span></a></li>
						</ul>
					</div>
				</div>
